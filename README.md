...
|----------|----------|--------|
| **Linux** | [IndexCheck-0.1.0.AppImage](releases/IndexCheck-0.1.0.AppImage) | AppImage (universal) |
| **Linux (Debian/Ubuntu)** | [indexcheck_0.1.0_amd64.deb](releases/indexcheck_0.1.0_amd64.deb) | .deb package |
